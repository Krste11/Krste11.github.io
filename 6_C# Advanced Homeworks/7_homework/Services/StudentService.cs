    ...
    public class StudentService
    {
        ...
        public void DeleteStudentById(int id)
        {
            using (SqlConnection conn = new SqlConnection(_connString))
            {
                ...
                string deleteGradesQuery = "DELETE FROM Grade WHERE StudentID = @Id";
                ...
                using (SqlCommand deleteStudentCmd = new SqlCommand(deleteStudentQuery, conn))
                {
        ...
        public void UpdateStudentFirstName(int id, string newFirstName)
        {
            ...
            {
                conn.Open();
                string query = "UPDATE Student SET FirstName = @FirstName WHERE ID = @Id";
